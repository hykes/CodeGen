...
public abstract class TemplateGroupTree {
  ...
  private void initTree() {
    ...
    myNorthPanel.add(ActionManager.getInstance().createActionToolbar("TemplateGroupTree", group, true).getComponent(), BorderLayout.WEST);
  ...
  private class MyFilterComponent extends FilterComponent {
    ...
    public void filter() {
      ...
      TemplateGroupTree.this.filter(filterModel(filter, true));
      if (myTree != null) {
